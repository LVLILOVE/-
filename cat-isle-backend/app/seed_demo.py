...
DEMO_CATS = [
    ...
    {"name": "布丁", "persona": "探险家", "story": "对每个角落都充满好奇", "breed": "英短",
    ...
    {"name": "小满", "persona": "运动健将", "story": "跑起来像一阵小旋风", "breed": "美短",
    ...
    {"name": "芝麻", "persona": "粘人精", "story": "睡在你腿上就不愿意下来", "breed": "狸花",
    ...
    {"name": "汤圆", "persona": "小吃货", "story": "听到零食袋的声音就会跑来", "breed": "白猫",
    ...
    {"name": "豆包", "persona": "安静美男子", "story": "喜欢在窗边看云发呆", "breed": "蓝猫",
